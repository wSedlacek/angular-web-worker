...
import { Instantiable, NonNullableMessageBus } from 'angular-web-worker/common';
...
export class ClientWebWorker<T> implements Worker {
   ...
   */
  private readonly messageBus: NonNullableMessageBus = {
    onmessage: () => {},
   ...
   */
  constructor(workerType: Instantiable<T>, private readonly isTestClient: boolean) {
   ...
   */
  public serialize = <O extends Object>(obj: O): O => {
